...
WORK = ROOT / '.checks/proot-exitkill-build'
...
def main():
    ...
    common = ['--target=aarch64-linux-android30', '-O2', '-D_FILE_OFFSET_BITS=64',
              ...
              '-DVERSION="5.1.107.92-tinyagent.1"', '-DPROOT_UNBUNDLE_LOADER="/unused"',
    ...
    report = {'source_sha256': sha(archive), 'patch_sha256': sha(patch),
