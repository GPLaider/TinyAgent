...
def adb(*args):
    return subprocess.check_output([str(ADB), '-s', '100.79.65.42:5555', *args], timeout=180)
assert adb('shell', 'getprop', 'ro.serialno').decode().strip() == 'ZY22HZPLL8'
...
report = dict(serial='ZY22HZPLL8', previous_apk_sha256=old_hash, phone_apk_sha256=EXPECTED,
